...
sub escribelog{
  ...
  $min=&bl($min);
  $seg=&bl($seg);
  my $log_file="/var/www/cgi-bin/log/resultado-agenda-$ao-$mes-$dia-$id_com.log";
...
$strsql="insert into auditor.auditor_on_line_batch (id_company,id_estatus,msisdn,oferta,address,fecha_ingreso,fecha_expiracion,fecha_inicio,transaccion_id,secuencia,operacion) values('$be','1','$dn','$ofer','$coe','$fe',concat((DATE_FORMAT('$expx','%Y-%m-%d')),' ','23:59:59'),'$fi','$id','$secu','$resor')";
