...
$strsql="SELECT  *   FROM auditor.auditor_on_line_batch_async  WHERE id_company='$be' and msisdn='$msisdn' and fecha_ingreso > date_sub(now(), interval 3 month) order by id_auditor_alta desc limit 5  ";
#print $strsql;
